    ...
    <div class="actions">
      ...
      <?php while($admin = mysqli_fetch_assoc($admin_set)) { ?>
        ...
        <tr>
          ...
          <td><a class="action" href="<?php echo url_for('/staff/admins/edit.php?id=' . h(u($subject['id']))); ?>">Edit</a></td>
          <td><a class="action" href="<?php echo url_for('/staff/admins/delete.php?id=' . h(u($subject['id']))); ?>">Delete</a></td>
    	  </tr>
      <?php } ?>
  	</table>
